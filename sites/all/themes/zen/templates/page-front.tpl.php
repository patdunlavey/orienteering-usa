...
<div id="banner" class="holder"><div id="banner-inner" class="sector"><?php print $content; ?></div></div>

<div id="nav" class="holder"><div id="nav-in" class="sector"><?php print $navigation; ?><div class="clearboth"></div></div></div><!-- nav -->

<div id="mid" class="holder"><div id="mid-inner" class="sector"></div></div>
